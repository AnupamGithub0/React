...
// import iphone from "../assets/samsungs21.jpg";
// import watch from "../assets/watch04.jpg";
...
export default function Homepage() {
  ...
  const fetchProducts = async () => {
    try {
      const res = await axios.get(
        "https://ecommercebackend02.onrender.com/api/v1/product/products"
      );
  ...
  const fetchingCategory = async () => {
    try {
      const res = await axios.get(
        "https://ecommercebackend02.onrender.com/api/v1/product/category"
      );
