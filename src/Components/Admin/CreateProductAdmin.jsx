...
export default function CreateProductAdmin() {
  ...
  const handleUploadProduct = async(e)=>{
    e.preventDefault()
    try {
      const res = await axios.post("https://ecommercebackend02.onrender.com/api/v1/product/create-product",{
        productName,category,costPrice,sellPrice,stock,description,productImages
      })
  ...
  return (
    <Container>
      <div className="container mx-auto p-8">
        ...
        <form onSubmit={handleUploadProduct} className="max-w-2xl mx-auto bg-white p-10 rounded-xl shadow-lg">
          {/* Product Name */}
          <div className="mb-6">
            <label
          ...
          <div className="flex items-center justify-center flex-col">
            <div className="relative overflow-hidden w-24 h-24 bg-transparent border-2 mb-3 ">
              <label>
                ...
                <input onChange={handleUploadImages} type="file"  className="hidden" />
              </label>
            </div>

            <div className="flex items-center mb-4">
              <div className="w-[140px] h-[140px] border-2"></div>
              <div className="w-[140px] h-[140px] border-2 ml-4"></div>
            </div>
          </div>
